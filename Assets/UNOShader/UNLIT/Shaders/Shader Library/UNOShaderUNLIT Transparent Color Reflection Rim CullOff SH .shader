...
//Version=1.6
Shader"UNOShader/_Library/UNLIT/UNOShaderUNLIT Transparent Color Reflection Rim CullOff SH "
{
	Properties
	{
	...
	SubShader
	{
		...
		UsePass "UNOShader/_Library/Helpers/Shadows Transparent/SHADOWCAST CULLOFF"
	} //-------------------------------SubShader-------------------------------
