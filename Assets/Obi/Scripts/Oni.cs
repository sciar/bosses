...
public static class Oni {
	...
	public struct Collider{
		...
		public Collider(UnityEngine.Collider source, ShapeType shapeType, int shapeIndex, int rigidbodyIndex, int materialIndex){
			bounds = new Oni.Bounds(source.bounds.min - Vector3.one*source.contactOffset,
									source.bounds.max + Vector3.one*source.contactOffset);
	...
	public struct TriangleMeshShape{
		...
		public TriangleMeshShape(MeshCollider source, MeshColliderType type, IntPtr vertexPositions, IntPtr triangleIndices){
			this.type = type;
			this.triangleThickness = source.contactOffset;
