...
{	
	...
	public bool AddToSolver(object info){
		...
		if (enabled)
			...
			Oni.DeactivateConstraints(actor.solver.Solver,
	...
	public bool RemoveFromSolver(object info){
		...
		Oni.RemoveConstraints(actor.solver.Solver,(int)GetConstraintType(),ConstraintCount,constraintOffset);
	...
	public void UpdateConstraintActiveStatus(){
		...
		Oni.ActivateConstraints(actor.solver.Solver,
								(int)GetConstraintType(),
