...
namespace Obi{
	...
	public class ObiBendingConstraints : ObiConstraints
	{
		...
		protected override void OnAddToSolver(object info){
			...
			Oni.SetBendingConstraints(solver.Solver,solverIndices,restBends.ToArray(),bendingStiffnesses.ToArray(),ConstraintCount,constraintOffset);
		...
		public override void PushDataToSolver(ObiSolverData data){ 
			...
			Oni.SetBendingConstraints(actor.solver.Solver,solverIndices,restBends.ToArray(),bendingStiffnesses.ToArray(),ConstraintCount,constraintOffset);
