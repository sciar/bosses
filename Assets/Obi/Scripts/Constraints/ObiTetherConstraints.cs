...
namespace Obi{
	...
	public class ObiTetherConstraints : ObiConstraints
	{
		...
		protected override void OnAddToSolver(object info){
			...
			Oni.SetTetherConstraints(solver.Solver,solverIndices,maxLengthsScales.ToArray(),stiffnesses.ToArray(),ConstraintCount,constraintOffset);
		...
		public override void PushDataToSolver(ObiSolverData data){ 
			...
			Oni.SetTetherConstraints(actor.solver.Solver,solverIndices,maxLengthsScales.ToArray(),stiffnesses.ToArray(),ConstraintCount,constraintOffset);
