...
public class ObiPinConstraints : ObiConstraints
{
	...
	protected override void OnAddToSolver(object info){
		...
		Oni.SetPinConstraints(solver.Solver,solverIndices,pinOffsets.ToArray(),stiffnesses.ToArray(),ConstraintCount,constraintOffset);
	...
	public override void PushDataToSolver(ObiSolverData data){ 
		...
		Oni.SetPinConstraints(actor.solver.Solver,solverIndices,pinOffsets.ToArray(),stiffnesses.ToArray(),ConstraintCount,constraintOffset);
